...
',
    ...
    'upload' => array(
        ...
        'invalidfiles' => 'یک یا تعدادی از فایل های شما بیش از حد بزرگ است یا یک نوع فایل است که مجاز نیست. فایل های مجاز عبارتند از PNG، GIF، JPG، JPEG، DOC، DOCX، PDF، TXT، ZIP، RAR، RTF، XML، و LIC.',
    ),
