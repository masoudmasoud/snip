<div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
        ...
        {!! $errors->first('address', '<span class="alert-msg"><i class="fa fa-times"></i>پیام: </span>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('address2') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
        ...
        {!! $errors->first('address2', '<span class="alert-msg"><i class="fa fa-times"></i>پیام: </span>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('city') ? ' has-error' : '' }}">
    ...
    {{Form::text('city', Input::old('city', $item->city), array('class' => 'form-control')) }}
        {!! $errors->first('city', '<span class="alert-msg"><i class="fa fa-times"></i>پیام: </span>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('state') ? ' has-error' : '' }}">
    ...
    {{Form::text('state', Input::old('state', $item->state), array('class' => 'form-control')) }}
        {!! $errors->first('state', '<span class="alert-msg"><i class="fa fa-times"></i>پیام: فقط دو حرف اول استان را وارد کنید.</span>') !!}
    </div>
</div>
...
<div class="form-group {{ $errors->has('zip') ? ' has-error' : '' }}">
    ...
    {{Form::text('zip', Input::old('zip', $item->zip), array('class' => 'form-control')) }}
        {!! $errors->first('zip', '<span class="alert-msg"><i class="fa fa-times"></i>پیام: </span>') !!}
    </div>
</div>