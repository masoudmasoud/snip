...
<div class="col-md-8 col-md-offset-2">
  ...
  <!-- Horizontal Form -->
    <div class="box box-default">
      ...
      <div class="col-md-7">
        <p>قسمت هایی که در گزارش سفارشی می خواهید را انتخاب کنید و روی دکمه تولید کلیک کنید. فایل گزارش به صورت خودکار برای شما دانلود شده و می توانید از اکسل برای مشاهده آن استفاده کنید.</p>
      </div>
