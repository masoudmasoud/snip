...
@section('header_right')
    ...
    @endcan
        ...
        @endif
    @can('users.view')
        <a class="btn btn-default pull-right" href="{{ URL::to('admin/users/export') }}" style="margin-right: 5px;">خروجی</a>
    @endcan
            ...
            @if (Input::get('status')!='deleted')
               ...
               <div id="toolbar">
                 <select name="bulk_actions" class="form-control select2" style="width: 200px;">
                     <option value="delete">حذف دسته جمعی &amp; گرفتن</option>
                 </select>
